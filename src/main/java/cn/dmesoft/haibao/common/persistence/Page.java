 ...
 */
package cn.dmesoft.haibao.common.persistence;
...
public class Page<T> {
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			sb.append("<li class=\"paginate_button prev disabled\"><a href=\"javascript:\">&#171; 上一页</a></li>\n");
		} else {
			sb.append("<li class=\"paginate_button prev\"><a href=\"javascript:\" onclick=\""+funcName+"("+prev+","+pageSize+",'"+funcParam+"');\">&#171; 上一页</a></li>\n");
		}
		...
		sb.append(" <li><span>" + pageNo + "/" + pageSize);
		sb.append(" 共" + count + "条</span></li>");

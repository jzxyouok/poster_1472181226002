 ...
 */
package cn.dmesoft.haibao.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new cn.dmesoft.haibao.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new cn.dmesoft.haibao.modules.sys.entity.User(null, userId)))){

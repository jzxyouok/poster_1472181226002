...
var appContextRoot='${pageContext.request.contextPath}/act';
	...
	<div id="main" class="wrapper full clearfix" style="padding-top:0;" ng-style="{height: window.height + 'px'}" ng-app="activitiModeler" ng-include="tplUrl + 'editor-app/editor.html'">
	</div>

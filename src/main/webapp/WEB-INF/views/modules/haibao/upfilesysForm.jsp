...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/haibao/upfilesys/">单表列表</a></li>
		<li class="active"><a href="${ctx}/haibao/upfilesys/form?id=${upfilesys.id}">单表<shiro:hasPermission name="haibao:upfilesys:edit">${not empty upfilesys.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="haibao:upfilesys:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="upfilesys" action="${ctx}/haibao/upfilesys/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">hbsrcthumb_varchar：</label>
			<div class="controls">
				<form:input path="hbsrcthumbVarchar" htmlEscape="false" maxlength="200" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="haibao:upfilesys:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>

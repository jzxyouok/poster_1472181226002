...
<body>
	...
	<div class="btn-toolbar breadcrumb">
		<div class="btn-group">
			<a class="btn" href="javascript:add();"><i class="glyphicon glyphicon-file"></i>新建</a>
			<a class="btn" href="javascript:edit();"><i class="glyphicon glyphicon-edit"></i>修改</a>
			<a class="btn" href="javascript:dele();" onclick="return confirmx('确认要删除该测试吗？', this.href)"><i class="glyphicon glyphicon-remove"></i>删除</a>
		</div>
		<div class="btn-group" >
			<a class="btn" onclick="$('#searchForm').toggle();su.autoHeight();"><i class="glyphicon glyphicon-search"></i>查询</a>
		</div>
	</div>

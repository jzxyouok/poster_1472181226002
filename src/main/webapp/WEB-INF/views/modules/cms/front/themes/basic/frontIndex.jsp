...
<head>
	...
	<meta name="description" content="dmesoft ${site.description}" />
	<meta name="keywords" content="dmesoft ${site.keywords}" />
</head>
<body>
    <div class="jumbotron" style="padding-bottom:35px;margin:10px 0;">
      ...
      <p><a href="${article.url}" class="btn btn-primary btn-lg">&nbsp;&nbsp;&nbsp;查看详情 &raquo;&nbsp;&nbsp;&nbsp;</a></p>
    </div>
    <div class="row">
      <div class="col-md-4">

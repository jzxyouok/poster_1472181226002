...
<meta name="author" content="http://dmesoft.cn"/><meta http-equiv="X-UA-Compatible" content="IE=7,IE=9,IE=10" />
...
<c:if test="${site.theme eq 'basic'}">
	...
	<link href="${ctxStatic}/common/haibao.min.css" type="text/css" rel="stylesheet" />

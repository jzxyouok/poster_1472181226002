            ...
            <section id="download-bootstrap">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><a class="btn btn-lg btn-primary" href="assets/bootstrap.zip" >下载Bootstrap</a></p>
                    </div>
                    <div class="col-md-6">
                        <h2>下载源码</h2>
                        <p>从GitHub直接下载到的最新版的源码包括CSS、JavaScript的源文件，以及一份文档。</p>
                        <p><a class="btn btn-lg" href="https://github.com/twitter/bootstrap/zipball/master" >下载Bootstrap源码</a></p>
                    </div>
                </div>
            </section>
        </div>

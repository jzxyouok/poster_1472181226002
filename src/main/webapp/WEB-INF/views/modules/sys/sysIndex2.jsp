	...
	<div id="main">
	    ...
	    <div class="container">
		    ...
		    <div id="footer" class="row">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')}<!--  - Powered By <a href="http://dmesoft.cn" target="_blank">dmesoft</a> ${fns:getConfig('version')} -->
			</div>
		</div>
	</div>
	<script type="text/javascript"> 

...
<body>
	<div id="assignRole" class="row col-md-12">
		<div class="col-md-4" style="border-right: 1px solid #A8A8A8;">
			<p>所在部门：</p>
		...
		<div class="col-md-3" style="padding-left:16px;border-left: 1px solid #A8A8A8;">
			<p>已选人员：</p>

...
<c:set var="activeTag" value="1" scope="request"/>
<ui:tab-default-layout config="modules/sys/menu/tab_config.jsp" title="菜单列表">
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="target" htmlEscape="false" maxlength="10" class="input-sm"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="sort" htmlEscape="false" maxlength="50" class="required digits input-sm"/>

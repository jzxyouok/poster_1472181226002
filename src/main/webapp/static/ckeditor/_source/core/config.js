...
CKEDITOR.config =
{
	 ...
	 * file you are using on your live haibao and want to assign the editor the same ID
	 ...
	 * of the editing area. This can be useful when you intend to reuse the original CSS
	 * file you are using on your live haibao and want to assign the editor the same class

...
angular.module("app", ["ngRoute", "spread", "ui.bootstrap", "ngSanitize", "ui.select", "main.data", "services.i18nNotifications", "services.httpRequestTracker", "services.config", "security.register.company", "security", "templates-app", "templates-common", "ui.sortable", "I18N.MESSAGES", "app.directives.notification", "common.directives.dropDown", "common.directives.scroll", "usercenter", "test", "eqxAuth"]), angular.module("app").config(["$routeProvider", "$locationProvider", "securityAuthorizationProvider", "uiSelectConfig", "$provide", "$httpProvider", "$tooltipProvider", "authServiceProvider", function(a, b, c, d, e, f, g, h) {
	...
	b.HB_STATIC = HB_STATIC, b.PREFIX_FILE_HOST = PREFIX_FILE_HOST, b.PREFIX_SERVER_HOST = PREFIX_URL, b.PREFIX_CLIENT_HOST = PREFIX_HOST, b.PREFIX_S3_URL = PREFIX_S3_URL, a.requestCurrentUser(), c.getLogo().then(function(a) {
		try {
			b.logoSrc = a.data
		} catch (c) {
			b.logoSrc = HB_STATIC + "assets/images/logo.png"
		}
	}, function() {
		b.logoSrc = HB_STATIC + "assets/images/logo.png"
	})
}]), angular.module("app").run(["security", "$rootScope", "configService", "$anchorScroll", "$location", "usercenterService", function(a, b) {
	b.HB_STATIC = HB_STATIC, b.PREFIX_FILE_HOST = PREFIX_FILE_HOST, b.PREFIX_SERVER_HOST = PREFIX_URL, b.PREFIX_CLIENT_HOST = PREFIX_HOST, b.PREFIX_S3_URL = PREFIX_S3_URL, b.PRINT_HOST_SERVER = PRINT_HOST_SERVER, b.PRINT_HOST_RESOURCE = PRINT_HOST_RESOURCE, b.PREFIX_ANALYSIS_HOST = PREFIX_ANALYSIS_HOST, a.requestCurrentUser();
	var c = $(document);
	b.load2 = function() {
		c.scroll(function() {
	...
	})) : 1 == c.type ? (a.title = "申请成为样例", a.description = "申请官方推荐，成为其他用户创建场景的原型样例，还可以赚取秀点", 4 == b.user.type && d.sceneTplPricesPromise.then(function(b) {
	...
	return {
		...
		controller: ["$scope", function(a) {
			a.noDataImg = HB_STATIC + "assets/images/userdata.svg"
		}]
	}
	...
	b.noDataImg = HB_STATIC + "assets/images/userdata.svg";
	var c = {
		type: "bar",
		data: [],
		label: {
	...
	return {
		restrict: "EA",
		template: '<div id="loading" style="display:block;"><div class="loading-con"><img ng-src="{{HB_STATIC}}assets/images/puff.svg"><p>发送中，请稍后</p></div><div class="loading-bg"></div></div>'
	}
	...
	b.obj = {}, b.qrCodeShow = !1, b.qrcodeList = [{
		...
		b.sinaurl = "http://service.weibo.com/share/share.php?url=" + encodeURIComponent(b.previewUrl) + "?from=sina_weibo&title=" + encodeURIComponent(b.scene.name) + "&pic=" + encodeURIComponent(PREFIX_FILE_HOST + b.scene.cover) + "&appkey=3508809852", b.qqurl = "http://connect.qq.com/widget/shareqq/index.html?url=" + encodeURIComponent(b.previewUrl) + "?from=sqq&title=" + b.scene.name + "&site=http://eqxiu.com&summary=" + (b.scene.description ? b.scene.description : "") + "&pic=" + PREFIX_FILE_HOST + b.scene.cover + "&desc=" + (b.scene.description ? b.scene.description : "") + "&appkey=3508809852", b.qqzoneurl = "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=" + encodeURIComponent(b.previewUrl) + "?from=qzone&title=" + b.scene.name + "&site=http://eqxiu.com&summary=" + (b.scene.description ? b.scene.description : "") + "&pic=" + PREFIX_FILE_HOST + b.scene.cover + "&desc=" + (b.scene.description ? b.scene.description : "") + "&appkey=3508809852"
	}), b.shareList = [{
		id: 1,
		type: "sina",
		icon: "eqf-weibo",
	...
	var k = e;
	e == i ? b.money = k : b.money = i + "-" + (i - k) + "=" + k, b.type = d, 1 == d ? b.payUrl = HB_STATIC + "download/vip1-201512.pdf" : 2 == d ? b.payUrl = HB_STATIC + "download/vip2-201512.pdf" : 3 == d ? b.payUrl = HB_STATIC + "download/vip4-201512.pdf" : 4 == d ? b.payUrl = HB_STATIC + "download/vip3-201512.pdf" : 10 == d && (b.payUrl = HB_STATIC + "download/xd-201512.pdf"), b.counts = h, b.payWay = "alipay", h && h.length > 0 && (b.curentCount = h[0].value);
	var l = {},
		m = {};
	...
	var b = [PREFIX_URL + "login", API_URL + "/scene/createPage?id=", PREFIX_URL + "m/scene/pageList", PREFIX_URL + "index.php?c=upfile&a=upload", PREFIX_URL + "m/c/group/create", PREFIX_URL + "index.php?c=scene&a=my", API_URL + "/scene/syslist", API_URL + "scene/saveSettings", PREFIX_URL + "m/scene/stat"];
	...
	var f = {
		...
		link: function(c) {
			c.PREFIX_FILE_HOST = PREFIX_FILE_HOST, c.isAuthenticated = a.isAuthenticated, c.login = a.showLogin, c.logout = a.logout, c.requestResetPassword = a.requestResetPassword, c.isAdvancedUser = b.isAdvancedUser, c.isEditor = b.isEditor, c.isVendorUser = b.isVendorUser, c.$watch(function() {
				...
				c.currentUser = a, c.currentUser.headImg ? /^http.*/.test(a.headImg) && (c.headImg = a.headImg) : c.headImg = HB_STATIC + "assets/images/defaultuser.jpg"
	...
	return b.openBindEmailDialog = function() {
		...
		a.open({
			...
			backdropClick: !1,
			windowClass: "confirm-dialog",
			templateUrl: tplUrl + "dialog/confirm.tpl.html",
		...
		a.open({
			...
			templateUrl: tplUrl + "dialog/message.tpl.html",
	...
	return j.getPageNames = function(b) {
		var c = "scene/pageList?id=" + b + "?date=" + (new Date).getTime();
		return a({
			withCredentials: !0,
			method: "GET",
			url: API_URL + c
...
angular.module("dialog/message.tpl.html", []).run(["$templateCache", function(a) {
 ...
 angular.module("footer.tpl.html", []).run(["$templateCache", function(a) {
	...
	a.put("spread/console/domainBind-guide.tpl.html", 'domainBind')
	...
	a.put("spread/console/guarantee-buy.tpl.html", '')
	...
	a.put("spread/tab/subtab/site-import.tpl.html", '<div><div class=site-import-area ng-repeat="contentText in contentTexts track by $index"><div class="site-import-title pb20">{{contentText.title}}</div><div class="site-import-col code-col"><div class=code-area><div class=code-con><div>&lt;iframe border=0 width=320px height=641px&nbsp;</div><div class=mid-con>src="{{selectedUrl}}"&gt;</div><div>&lt;/iframe&gt;</div></div><div class="copy-link fr"><a ng-if=isSafari class="btn btn-border" ng-click=copyUrl()><span class=eqf-scene-copy></span> 复制代码</a> <a ng-if=!isSafari class="btn btn-border" copy-button url={{contentText.url}}><span class=eqf-scene-copy></span> 复制代码</a></div></div></div><div class="site-import-col des-col"><div class="des-area fr"><div>{{contentText.textOne}}</div><div class=mid-con>{{contentText.textTwo}}</div><div class=mid-con>{{contentText.textThree}}</div></div></div></div><div class="site-import-area weiqidian">还没有炫酷H5网站？<a href=http://www.wqdian.com target=_blank><ins>立即免费创建一个！</ins></a></div></div>')
}]), angular.module("spread/tab/subtab/social-share.tpl.html", []).run(["$templateCache", function(a) {
	a.put("spread/tab/subtab/social-share.tpl.html", '<div class=share-header><span class="title share-tab-title">社交渠道分享</span> </div><div class=qrcode-area><div class="share-qrcode fl"><div class=qr-size qr-code-size=160 qr-url={{previewUrl}} ng-if="scene.staticStatus !== 1"></div><div class=qr-size qr-code-size=160 qr-url={{urlVip}} ng-if="scene.staticStatus === 1"></div><div class=qrcode-select><p>下载二维码</p><a class="btn btn-border background-color-width-change mr20" ng-click=downloadQrcode(qrcodeObj) ng-repeat="qrcodeObj in qrcodeList"><span class=eqf-download2></span> &nbsp;{{qrcodeObj.name}}</a></div></div><ul class=bdsharebuttons><li><a ng-href={{sinaurl}} target=_blank data-event=8202><img ng-src="{{HB_STATIC}}assets/images/weibo.jpg"></a></li><li><a ng-href={{qqurl}} target=_blank data-event=8203><img ng-src="{{HB_STATIC}}assets/images/qq.jpg"></a></li><li><a ng-href={{qqzoneurl}} target=_blank data-event=8204><img ng-src="{{HB_STATIC}}assets/images/qqzone.jpg"></a></li></ul><div class=download-area download-canvas ng-if="scene.staticStatus !== 1"><div class=qr-size qr-code-size=256 qr-url={{previewUrl}}></div><div class=qr-size qr-code-size=512 qr-url={{previewUrl}}></div><div class=qr-size qr-code-size=1024 qr-url={{previewUrl}}></div></div><div class=download-area download-canvas ng-if="scene.staticStatus === 1"><div class=qr-size qr-code-size=256 qr-url={{urlVip}}></div><div class=qr-size qr-code-size=512 qr-url={{urlVip}}></div><div class=qr-size qr-code-size=1024 qr-url={{urlVip}}></div></div></div><ul class="nav nav-pills no-border overscanwx"><li class=share-title>扫一扫分享到微信</li></ul><div class=url-share><span>复制链接分享</span><div class=url-input><label type=text id=copy-social-url class=form-control>{{previewUrl}}</label><a ng-if=isSafari class="btn btn-border ml20 copy-btn" ng-click="copyUrl(\'copy-social-url\')"><span class=copy-span><span class=eqf-scene-copy copy-button></span> &nbsp;复制链接</span></a> <a ng-if=!isSafari class="btn btn-border ml20 copy-btn" copy-button url={{previewUrl}}><span class=copy-span><span class=eqf-scene-copy copy-button></span> &nbsp;复制链接</span></a></div><div class="line url-share-line" ng-show=!branchid style=margin-top:8px></div><div class=share-plan ng-show=!branchid><span class=share-tab-title>加入场景秀分享计划</span><div class=plan-area><div class="plan-option join-show background-color-width-change hint--right hint--rounded" ng-class="{\'plan-option-selected\': obj.applyShow}" data-hint="{{tip ? tip : obj.publishTime?\'申请加入秀场\':\'发布后才能申请\'}}"><div class=checkbox-square ng-class="{checked: obj.applyShow}"><em class=eqf-clickmore></em> <input type=checkbox ng-model=obj.applyShow name=iCheck ng-change="applyFunc(obj.applyShow, 2, null)" ng-disabled="scene.isShow==1 || scene.isShow==2 || !scene.publishTime || scene.status == -1 || scene.status == -2 || scene.accessCode || scene.status== 2"></div><span>申请加入秀场</span></div><div class="plan-option activity-select" ng-show=obj.applyShow><eqx-select class="select-sm select-contain border-width" model=obj.sceneTag change="applyFunc(true, 2, obj.sceneTag.id)"><eqx-select-option value=null>选择类型</eqx-select-option><eqx-select-option value=sceneTag ng-repeat="sceneTag in sceneTags">{{sceneTag.name}}</eqx-select-option></eqx-select></div></div><div class=plan-area><div class="plan-option activity-select" ng-show="obj.applySample && user.type==4"><eqx-select class="select-sm select-contain border-width" model=obj.tplPrice change="applyFunc(true, 1, obj.tplPrice.id)"><eqx-select-option value=tplPrice ng-repeat="tplPrice in tplPrices">{{tplPrice.name}}</eqx-select-option></eqx-select></div><div class="apply-des ml20" ng-if="scene.applyTemplate==1"><span class=eqf-clock-o></span> 申请中</div><div class="apply-des ml20 success" ng-if="scene.applyTemplate==2"><span class=eqf-glyphicon-ok></span> 申请成功</div><div class="apply-des ml20 fail" ng-if="scene.applyTemplate==-1"><span class=eqf-fobden></span> 申请失败，请重新申请</div></div><div class=share-activity ng-show=!branchid><ul class=join-activity ng-repeat="activity in activities"><li><div class="srcImg activity"><img ng-if=activity.path ng-src={{activity.path}} title={{activity.title}}></div><div class="activity-info activity"><p class=activity-title><em>{{activity.title}}</em></p></div><div class="activity-info activity"><p class=activity-details><em>作品：{{activity.joinNum}}</em> <em>截止：{{activity.endDate | date:\'yyyy-MM-dd\'}}</em></p></div><div class="activity-apply activity"><a class="btn btn-border btn-join" ng-click="applyFunc(true, 3, activity.sceneId, activity.id)">参加</a></div></li></ul></div></div><div ng-class="{showin: $parent.showApplyTip}" class="showxiu show-pos" style="box-shadow: 0 5px 15px rgba(0, 0, 0, 0.5)"><div class=modal-header><button type=button class=close data-dismiss=modal aria-label=Close ng-click=closeActivityModal();><span aria-hidden=true>×</span></button><h4 class=modal-title>参加活动</h4></div><div class=modal-body><p style="line-height: 30px">参加活动后，不可取消或选择其他活动。</p></div><div class=modal-footer><input type=checkbox style=margin-top:0;margin-right:5px ng-model=hideApplyTip ng-init="hideApplyTip=true;"><span style=margin-right:10px>不再提示</span> <a type=button class="btn btn-primary" ng-click="switchApplyActivityTip(true, 3, obj.selectedActivity.sceneId, obj.selectedActivity.id, hideApplyTip);$parent.showApplyTip=false;">确定</a></div></div>')
}]), angular.module("spread/tab/subtab/thirdweb.tpl.html", []).run(["$templateCache", function(a) {
	a.put("spread/tab/subtab/thirdweb.tpl.html", '<div class=pro-third-web><div class=third-web-header><p class=third-web-title>投放方案选择</p><div class=pl250><a class="btn third-web-btn" ng-class="{thirdActive: schemeFlg == \'humanSea\'}" ng-click="tabChange(\'humanSea\')">人海战术</a> <a class="btn third-web-btn" ng-class="{thirdActive: schemeFlg == \'directPush\'}" ng-click="tabChange(\'directPush\')" data-event=8208>网红直推</a></div></div><div class=third-web-bingjun ng-if="schemeFlg == \'humanSea\'"><div class="order-info pl250"><div class="numbers p20"><p class=bingjun-title>投放人数</p><input class=input-fans type=text value={{perPrice}}元/人 ng-readonly="true"> <span style="font-size: 16px">&times;</span> <a class="btn btn-plus" ng-click=minusFans()>-</a> <input class=input-fans type=text value="{{fansCount | number}}" ng-readonly="true"> <a class="btn btn-plus" ng-click=addFans()>+</a></div><div class="bingjun-left p20"><p>订单金额</p><p class=bingjun-cost><span style="font-size: 14px">&yen;</span>{{orderPrice}}</p></div></div><div class="bingjun-subtotal mt20"><span class="bingjun-msg pl250">按照广告覆盖人数收费，人数不同价格会有所不同。</span></div><div class="confirm-order pl250"><a class="btn btn-order green" ng-click=confirmOrder() data-event=8207>确认下单</a></div></div><ul class="clearfix thirdweb" ng-if="schemeFlg == \'directPush\'" style="padding-left: 124px"><li><a ng-click=confirmOrder()><img ng-src={{HB_STATIC}}promotion/assets/images/spread3.png data-event="820801"></a><div class=bg></div></li><li><a href="http://www.myunmei.com/?hmsr=YQX" target=_blank><img ng-src={{HB_STATIC}}promotion/assets/images/spread4.png data-event="820802"></a><div class=bg></div></li><li><a href="http://www.muqian.com/" target=_blank><img ng-src={{HB_STATIC}}promotion/assets/images/spread1.jpg data-event="820803"></a><div class=bg></div></li></ul></div>')
	...
	a.put("test/test-scene.tpl.html", '<div class=error><div class=header><div class=content><div class=logo><a href=/home target=_blank><img ng-src={{HB_STATIC}}assets/images/logoo.png alt=""></a></div></div></div><div class=error_contain><div class=error_con><img ng-src={{HB_STATIC}}assets/images/404_03.png alt=""><p style="font-size:24px;margin-top:30px;margin-bottom:15px;padding:0 10px">对不起，您想要进入的页面已经去火星了！</p></div></div></div><div ng-include="\'footer.tpl.html\'"></div>')
